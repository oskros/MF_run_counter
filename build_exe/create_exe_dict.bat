...
pyinstaller "C:\Users\oskro\PycharmProjects\MF_counter_releases\build_exe\mf_timer_dict.spec" --windowed --clean --icon="C:\Users\oskro\PycharmProjects\MF_counter_releases\icon.ico"
