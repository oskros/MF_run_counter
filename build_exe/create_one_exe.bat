...
pyinstaller "C:\Users\oskro\PycharmProjects\MF_counter_releases\build_exe\mf_timer_onefile.spec" --windowed --onefile --clean --icon="C:\Users\oskro\PycharmProjects\MF_counter_releases\icon.ico"
