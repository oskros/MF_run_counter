...
pyinstaller "C:\Users\oskro\PycharmProjects\MF_counter_releases\mf_timer_onefile.spec" --windowed --onefile --clean --icon="C:\Users\oskro\PycharmProjects\MF_counter_releases\media\icon.ico"
