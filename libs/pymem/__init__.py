...
class Pymem(object):
    ...
    def __init__(self, process_name=None, verbose=True, debug=None):
        ...
        if process_name:
            self.open_process_from_name(process_name, verbose=verbose, debug=debug)
        self.check_wow64()
    ...
    def open_process_from_id(self, process_id, verbose=True, debug=None):
