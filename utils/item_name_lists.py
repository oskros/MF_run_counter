FULL_ITEM_LIST = [
    ...
    "Biggin's Bonnet", "Bing Sz Wang", "Black Cleft", "Black Hades", "Blackbog's Sharp", "Blackhand Key",
    ...
    "Bloodtree Stump", "Bone Break", "Boneflame", "Boneflesh", "Bonehew", "Boneshade", "Boneslayer Blade",
    ...
    "Coldkill", "Cold Rupture", "Coldsteel Eye", "Corpsemourn", "Cow King's Hide", "Cow King's Hooves",
    "Cow King's Horns", "Crack of the Heavens", "Crainte Vomir", "Cranebeak", "Credendum", "Crescent Moon", "Crow Caw",
    ...
    "Flamebellow", "Flame Rift", "Fleshrender", "Fleshripper", "Frostburn", "Frostwind", "Gargoyle's Bite",
    ...
    "Rogue's Bow", "Rotting Fissure", "Rune Master", "Rusthandle", "Sander's Paragon", "Sander's Riprap",
