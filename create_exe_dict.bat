...
pyinstaller "C:\Users\oskro\PycharmProjects\MF_counter_releases\mf_timer_dict.spec" --windowed --clean --icon="C:\Users\oskro\PycharmProjects\MF_counter_releases\media\icon.ico"
